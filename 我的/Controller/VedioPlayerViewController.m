...
- (void)viewDidLoad {
    ...
    NSString * URLString = @"http://flv2.bn.netease.com/videolib3/1608/24/POSGD5448/SD/movie_index.m3u8";
    wmPlayer = [[WMPlayer alloc]initWithFrame:playerFrame videoURLStr:URLString];
